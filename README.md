...
As for energy consumption, ~~it could vary from 10W to 20W* as the "server" is just an old MacBook 5,2 (Mid-2009) with no battery with a 60W charger~~ currently, it'll be changed to a VM inside my personal laptop as using the other machine would be a little bit of a problem. now it could vary from 10W to 20W, depending on the load of the server. And from energy transformation, it transforms energy to heat as the processor get hot.
